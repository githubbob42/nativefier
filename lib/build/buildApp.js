...
function changeAppPackageJsonName(appPath, name, url) {
  ...
  _fs2.default.writeFileSync(packageJsonPath, JSON.stringify(packageJson, null, 2));
}
...
function buildApp(src, dest, options, callback) {
  ...
  copy(src, dest, function (error) {
    ...
    _fs2.default.writeFileSync(_path2.default.join(dest, '/nativefier.json'), JSON.stringify(appArgs, null, 2));
