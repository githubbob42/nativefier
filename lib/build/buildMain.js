...
function maybeNoAppCopyrightOption(options) {
    ...
    if (options.platform === 'win32' && !isWindows()) {
        if (!_hasbin2.default.sync('wine')) {
            _loglevel2.default.warn('Wine is required to use "app-copyright" option for a Windows app when packaging on non-windows platforms');
...
function maybeNoBuildVersionOption(options) {
    ...
    if (options.platform === 'win32' && !isWindows()) {
        if (!_hasbin2.default.sync('wine')) {
            _loglevel2.default.warn('Wine is required to use "build-version" option for a Windows app when packaging on non-windows platforms');
...
function maybeNoAppVersionOption(options) {
    ...
    if (options.platform === 'win32' && !isWindows()) {
        if (!_hasbin2.default.sync('wine')) {
            _loglevel2.default.warn('Wine is required to use "app-version" option for a Windows app when packaging on non-windows platforms');
...
function maybeNoVersionStringOption(options) {
    ...
    if (options.platform === 'win32' && !isWindows()) {
        if (!_hasbin2.default.sync('wine')) {
            _loglevel2.default.warn('Wine is required to use "version-string" option for a Windows app when packaging on non-windows platforms');
...
function maybeNoWin32metadataOption(options) {
    ...
    if (options.platform === 'win32' && !isWindows()) {
        if (!_hasbin2.default.sync('wine')) {
            _loglevel2.default.warn('Wine is required to use "win32metadata" option for a Windows app when packaging on non-windows platforms');
